        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-3">
                    ...
                    <p class="text-uppercase mb-2">Daftar Nilai <?= 'Semester ' . $semester; ?></p>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="/daftar_nilai">Daftar Nilai</a></li>
                        <li class="breadcrumb-item"><a href="/daftar_nilai/nilai_siswa_periode/<?= $id_periode; ?>">Nilai Peserta Didik T.A <?= $tahun_ajaran; ?></a></li>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div>
                                <a href="/daftar_nilai/nilai_siswa_periode/<?= $id_periode; ?>" class="btn btn-primary btn-sm">Kembali</a>
                            </div>
                            <div>
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#tambah_nilai"><i class="fas fa-plus"></i> Tambah
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                    ...
                                                    data-nilaipts="<?= $data['pts']; ?>"
                                                    data-nilaipas="<?= $data['pat']; ?>"
                                                    title="Ubah nilai"><i class="fas fa-edit"></i> Ubah</button>
                                            </td>
                                        </tr>
                                    <?php
                                    endforeach;
            ...
            <div class="modal fade" id="tambah_nilai" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="/daftar_nilai_siswa/tambah" method="post">
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">PTS</label>
                                            <input type="text" class="form-control" placeholder="Nilai PTS" name="pts">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">PAT</label>
                                            <input type="text" class="form-control" placeholder="Nilai PAS" name="pas">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="ubah_nilai" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="/daftar_nilai_siswa/ubah" method="post">
                            <div class="modal-body">
                                <div class="row mb-3">
                                    <div class="col">
                                        <h6 class="text-uppercase">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label fw-bold" for="input_pts">PTS</label>
                                            <input type="text" class="form-control" name="pts" id="input_pts">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold" for="input_pas">PAT</label>
                                            <input type="text" class="form-control" name="pas" id="input_pas">
                                        </div>
                                    </div>
                                </div>
                            </div>
