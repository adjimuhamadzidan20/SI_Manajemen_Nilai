                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                Ubah</button>
                                                <a href="/daftar_kelas/hapus/<?= $data['id_kelas']; ?>" class="btn btn-primary btn-sm" onclick="return confirm('Anda ingin menghapusnya?')">Hapus</a> 
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                ...
                <div class="modal-content">
                  ...
                  <form action="/daftar_kelas/tambah" method="post">  
                    <div class="modal-body">
                      <div class="mb-3">
                        <label for="exampleInputKdKelas" class="form-label">KD Kelas</label>
                ...
                <div class="modal-content">
                  ...
                  <form action="/daftar_kelas/ubah" method="post">  
                    <div class="modal-body">
                      ...
                      <div class="mb-3">
                        <label for="input_kdkelas" class="form-label">KD Kelas</label>
