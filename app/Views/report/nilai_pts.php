            ...
            <main>
                <div class="container-fluid px-3">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="/cetak_laporan/cetak_pts/<?= $id_periode; ?>">Cetak Nilai PTS T.A <?= $tahun_ajaran; ?></a></li>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="d-none d-sm-inline">
                                ...
                                if ($jumlah > 0) {
                                ?>
                                    <a href="/laporan_nilai_pts/cetak_nilai_pts_pdf/<?= $kelas; ?>/<?= $id_jurusan; ?>/<?= $nama_mapel; ?>/<?= $id_mapel; ?>/<?= $id_periode; ?>/<?= $semester; ?>" class="btn btn-primary btn-sm"><i class="fas fa-file-pdf"></i> Cetak PDF</a>
                                    <a href="/laporan_nilai_pts/cetak_nilai_pts_excel/<?= $kelas; ?>/<?= $id_jurusan; ?>/<?= $nama_mapel; ?>/<?= $id_mapel; ?>/<?= $id_periode; ?>/<?= $semester; ?>" class="btn btn-primary btn-sm"><i class="fas fa-file-excel"></i> Cetak Excel</a>
                                <?php
                                } else {
                                ?>
                                    <button href="/laporan_nilai_pts/cetak_nilai_pts_pdf/<?= $kelas; ?>/<?= $id_jurusan; ?>/<?= $nama_mapel; ?>/<?= $id_mapel; ?>/<?= $id_periode; ?>/<?= $semester; ?>" class="btn btn-primary btn-sm" disabled><i class="fas fa-file-pdf"></i> Cetak PDF</button>
                                    <button href="/laporan_nilai_pts/cetak_nilai_pts_excel/<?= $kelas; ?>/<?= $id_jurusan; ?>/<?= $nama_mapel; ?>/<?= $id_mapel; ?>/<?= $id_periode; ?>/<?= $semester; ?>" class="btn btn-primary btn-sm" disabled><i class="fas fa-file-excel"></i> Cetak Excel</button>
                                <?php
                                }
                                ?>
                            </div>
                        ...
                        ?>
                            <div class="border p-2">
                                <div class="fw-normal text-center">Data nilai PTS belum tersedia..</div>
                            </div>
                        <?php
                            }
                        ?>
