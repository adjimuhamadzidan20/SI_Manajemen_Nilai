        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-3">
                    ...
                    <p class="text-uppercase mb-2">Nilai PAS | <?= 'Semester '. $semester; ?></p>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="/daftar_nilai">Daftar Nilai</a></li>
                        <li class="breadcrumb-item"><a href="/daftar_nilai/nilai_pas_periode/<?= $id_periode; ?>">Nilai Tugas T.A <?= $tahun_ajaran; ?></a></li>
                        <li class="breadcrumb-item active"><?= $kelas; ?> <?= $nama_jurusan; ?> <?= $nama_mapel; ?> - <?= $semester; ?></li>
                    </ol>
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div>
                                <a href="/daftar_nilai/nilai_pas_periode/<?= $id_periode; ?>" class="btn btn-primary btn-sm">Kembali</a>
                            </div>
                            <div>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered" style="width:100%" id="tabel_pas">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-start">Nilai PAS</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-start"><?= $data['nilai_pas']; ?></td>
                                            <td class="text-center">
                                                <button type="button" class="btn btn-primary btn-sm" 
                                                data-bs-toggle="modal" 
                                                data-bs-target="#ubah_nilai_pas"
                                                data-idpas="<?= $data['id_pas']; ?>"
