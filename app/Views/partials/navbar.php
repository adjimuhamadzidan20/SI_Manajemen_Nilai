<!-- Navbar Brand-->
<a class="navbar-brand ps-3 text-uppercase fs-6 me-1" href="/"><img src="<?= base_url('assets'); ?>/assets/img/smk_angkasa_1.png" alt="smk_angkasa_1" class="me-1" style="width: 42px;"> SI Manajemen Nilai</a>
<!-- Sidebar Toggle-->
