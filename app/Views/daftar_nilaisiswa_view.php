        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-3">
                    <h3 class="text-uppercase mt-3">Nilai Peserta Didik</h3>
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Nilai Peserta Didik T.A <?= $tahun_ajaran; ?></li>
                    </ol>
                    <div class="card">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="/daftar_nilai_siswa/peserta_didik/<?= $data['kelas']; ?>/<?= $data['id_jurusan']; ?>/<?= $data['nama_mapel']; ?>/<?= $data['id_mapel']; ?>/<?= $id_periode; ?>/Ganjil" class="btn btn-primary btn-sm">Ganjil</a>
                                                <a href="/daftar_nilai_siswa/peserta_didik/<?= $data['kelas']; ?>/<?= $data['id_jurusan']; ?>/<?= $data['nama_mapel']; ?>/<?= $data['id_mapel']; ?>/<?= $id_periode; ?>/Genap" class="btn btn-primary btn-sm">Genap</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
